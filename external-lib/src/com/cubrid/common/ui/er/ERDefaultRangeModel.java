 ...
 *
 * Contributors:
 *     Search Solution Corporation - Rewrite class
 *******************************************************************************/
...
/**
 * Extended generic implementation for a RangeModel.
 * 
 * 
 * <pre>
 *                    |<----extent--->|                     
 ...
 * 
 * @author Yu Guojia
 * @version 1.0 - 2014-2-28 created by Yu Guojia
 */
public class ERDefaultRangeModel implements
		RangeModel {
	...
	final private int RIGHT_BOTTOM_SPACE = 100;// for the space value of canvas on the right and bottom
	...
	public void setAll(int min, int ext, int max) {
		...
		int oldMax = maximum;
		maximum = max + RIGHT_BOTTOM_SPACE;
		minimum = min;
		extent = ext;
		if (oldMax != maximum) {
	...
	public void setMaximum(int maximum) {
		if (this.maximum + RIGHT_BOTTOM_SPACE == maximum) {
			return;
		}
		int oldValue = this.maximum;
		this.maximum = maximum + RIGHT_BOTTOM_SPACE;
