...
*/
public interface IContentAssistProcessor extends org.eclipse.jface.text.contentassist.IContentAssistProcessor {
	...
	/**
	 * Returns a list of completion proposals based on the
	 * specified location within the document and the selected item in first proposals that corresponds
	 * to the current cursor position within the text viewer.
	 * @param viewer
	 * @param offset
	 * @param selectedProposal
	 * @return
	 * 
	 */
