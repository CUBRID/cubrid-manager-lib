...
public interface ISubjectControlContentAssistProcessor extends IContentAssistProcessor {
	...
	/**
	 * * Returns a list of completion proposals based on the specified location
	 * and the selected item in first proposals
	 * within the document that corresponds to the current cursor position
	 * within the text viewer.
	 ...
	 * @return
	 */
	ICompletionProposal[] computeSecondProposals(IContentAssistSubjectControl contentAssistSubjectControl, int documentOffset, ICompletionProposal selectedProposal);
